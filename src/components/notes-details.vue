      ...
      <div class="operation form-group row no-gutters" role="group">
        <!--<div class="row">-->
          <div class="col-6 text-left">
            <div>
              <!--图片-->
              <button type="button" class="btn" title="插入图片">
              ...
              <!-- undo -->
              <button type="button" class="btn" title="撤销">
              ...
              <!-- redo -->
              <button type="button" class="btn " title="重做">
              ...
              <!--历史记录-->
              <button type="button" class="btn " title="历史记录">
          ...
          <div class="col-6 text-right position-relative">
            <div class="mr-5 pr-5">
              <!--保存-->
              <button type="button" class="btn" @click.stop.prevent="autoSave" title="保存">
              ...
              <!--预览-->
              <button type="button" class="btn" title="预览">
              ...
              <!--全屏-->
              <button type="button" class="btn " title="全屏">
